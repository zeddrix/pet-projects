...
const mainWomenCharacters1 = [
  ...
  {
    question:
      "She betrayed Samson, a Nazarite judge, in exchange for 1,100 silver pieces.",
...
const kings = [
  ...
  },
  {
    ...
    clueSourceContent:
      "17 As soon as Aʹhab saw E·liʹjah, he said to him: “Is this you, the one bringing great trouble on Israel?” 18  To this he said: “I have not brought trouble on Israel, but you and the house of your father have, by abandoning the commandments of Jehovah and by following the Baʹals.",
    choiceA: "Abijah",
    choiceB: "Joash",
    choiceC: "Ahab",
    choiceD: "Jeroboam",
  ...
  },
  {
    ...
    clueSourceContent:
      "12 The king’s secretaries were then called on the 13th day of the first month. They put in writing all of Haʹman’s orders to the king’s satraps, the governors who were over the provinces, and the princes of the different peoples, to each province in its own script and to each people in its own language. It was written in the name of King A·has·u·eʹrus and sealed with the king’s signet ring. 13  The letters were sent by means of couriers to all the king’s provinces, giving the order to annihilate, to kill, and to destroy all the Jews, young and old alike, children and women, on a single day, on the 13th day of the 12th month, that is, the month of Aʹdar, and to seize their possessions.",
    choiceA: "Cyrus",
    choiceB: "Ahasuerus",
    choiceC: "Zedekiah",
    choiceD: "Ahab",
  ...
  },
  {
    ...
    clueSource: "1 Kings 5:8-10",
    clueSourceContent:
      "So Hiʹram sent word to Solʹo·mon: “I have h8 eard the message you sent to me. I will do all you desire in providing the cedar and juniper timbers. 9  My servants will bring them down from Lebʹa·non to the sea, and I will make them into log rafts to go by sea to the place that you designate to me. I will have them broken up there, and you can carry them away. In exchange, you will provide the food that I request for my household.” 10  So Hiʹram supplied all the timbers of cedar and juniper that Solʹo·mon desired.",
    choiceA: "David",
    choiceB: "Josiah",
    choiceC: "Hiram",
    choiceD: "Belshazzar",
